...
Rails::Initializer.run do |config|
  ...
  config.action_controller.session = {
    :session_key => '_Fleet_session_',
    :secret      => '038c8ce7bda0bc14acc1be5f9ef0fa185c134197cf0a895d3fc74b77945378f7fa1f49513e57cd3e6a9acb16579523ca865268aadfbf3617423877155addfef9'
  }

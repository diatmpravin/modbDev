module AuthenticatedSystem
  protected
    ...
    # Shortcut for current account, based on current user
    def current_account
    ...
    def self.included(base)
      base.send :helper_method, :current_user, :current_account, :logged_in?
    end

    # Called from #current_user.  First attempt to login by the account id stored in the session.
